...
public class TestController {
	...
	public ModelAndView index(@RequestParam("file") MultipartFile file) throws Exception {
		...
		KakaoApiService.sendMesageAPI("http://210.93.181.229:9090/v1/send/kakao-friend", "01063277420", "Y2xhc3M6c2VjcmV0MTIhQA==", "d6b73318d4927aa80df1022e07fecf06c55b44bf", "당신의 나이는 : " + age + " 당신의 성별은 : " + gender);
	...
	public ModelAndView analysis(Model model) {
		...
		return new ModelAndView("test2/test21");
	}
