...
<script type="text/javascript">
    ...
    function drawChart() {
     ...
     /*  data.addRows([
		...
		/* <c:forEach var="drinkSalesGraphInfoByTime" items="${drinkSalesGraphInfoByTimeList}">
		<c:choose>
			<c:when test="${drinkSalesGraphInfoByTime.drink1Name!='' &&drinkSalesGraphInfoByTime.drink2Name!='' &&drinkSalesGraphInfoByTime.drink3Name!=''}">
					[${drinkSalesGraphInfoByTime.sellDate}, ${drinkSalesGraphInfoByTime.drink1}, ${drinkSalesGraphInfoByTime.drink2}, ${drinkSalesGraphInfoByTime.drink3}],
			</c:when>
			
			<c:when test="${drinkSalesGraphInfoByTime.drink1Name!='' &&drinkSalesGraphInfoByTime.drink2Name!=''}">
				[${drinkSalesGraphInfoByTime.sellDate}, ${drinkSalesGraphInfoByTime.drink1}, ${drinkSalesGraphInfoByTime.drink2}],
			</c:when>

				<c:when test="${drinkSalesGraphInfoByTime.drink1Name!=''}">
				[${drinkSalesGraphInfoByTime.sellDate}, ${drinkSalesGraphInfoByTime.drink1}],
			</c:when>
	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li><a class="text-center" onclick="moveMachine()" id="navi3"><i
						class="fa fa-calculator fa-3x"></i> <br>Machine</a></li>
				<li><a class="active-menu" onclick="moveAnalysis()"><i
