      ...
      <img src="/resources/assets/img/profile.jpg" style="width:50px; height:50px; border-radius:50%; "/>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a  class="active-menu" onclick="moveMachine()" id="navi3"><i class="fa fa-calculator fa-3x"></i> <br>Machine</a>
                    </li>
						   <li  >
        ...
        <div id="page-wrapper" >
           ...
           <!--     <span class="icon-box bg-color-red set-icon">
                ...
                <div class="text-box" >
                    <p class="main-text">실시간 자판기 총현황</p><hr/>
...
<!--                <span class="icon-box bg-color-blue">
                ...
                <div class="text-box">
                    <p class="main-text">실시간 작동 현황</p><hr/>
                    
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-6"> 
                            <div class="notice-blue">
                                <i class="fa fa-wrench fa-2x" style="width:30px; height:30px;color:#fff"></i>
                                <span style="margin-left:10px; font-size:15pt; color:#fff;">기기가 정상 작동중입니다.</span></div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6"> 
                            <div class="notice-red">
                                <i class="fa fa-cart-arrow-down fa-2x" style="width:30px; height:30px;color:#fff"></i>
                                <span style="margin-left:10px; font-size:15pt; color:#fff;">재고가 부족합니다.</span></div>
                        </div>
                    </div>
               ...
               <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="row">
                     <div class="panel panel-back noti-box">
                        <div class="text-box">
                    <p class="main-text">자판기별 매출 현황</p><hr/>
               ...
               <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="row">
                     <div class="panel panel-back noti-box">
                        <div class="text-box">
                    <p class="main-text">자판기별 재고 현황</p><hr/>
